# service-template-node [![Build Status](https://travis-ci.org/physikerwelt/service-template-node.svg?branch=master)](https://travis-ci.org/physikerwelt/service-template-node)
